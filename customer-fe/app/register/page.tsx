        ...
        <div className="max-w-md mx-auto">
            ...
            <div className="p-6 md:p-8">
              <div className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-linear-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 disabled:from-gray-300 disabled:to-gray-400 disabled:cursor-not-allowed text-white font-semibold py-2.5 md:py-3 rounded-xl transition-all transform hover:scale-105 shadow-lg flex items-center justify-center gap-2 text-sm md:text-base cursor-pointer"
                >
                  <svg
          ...
          <div className="mt-4 md:mt-6 bg-green-50 border-2 border-green-200 rounded-xl md:rounded-2xl p-3 md:p-4">
            <div className="flex items-start gap-2 md:gap-3">
              ...
              <div>
                <h4 className="text-gray-800 font-semibold text-xs md:text-sm mb-1">
                  Quick Registration
                </h4>
